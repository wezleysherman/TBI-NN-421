...
public class Settings implements Serializable {
	...
	public Settings(String fName, String lName, Date pDate, String pNotes) {
		this(fName, lName, pDate, pNotes, wrapScan(pDate, null));
	}
	
	//constructor for fresh patient with 1 scan
	public Settings(String fName, String lName, Date pDate, String pNotes, File pScan) {
		this(fName, lName, pDate, pNotes, wrapScan(pDate, pScan));
	}
	
	//constructor for patient w/ established uid with 1 scan
	public Settings(String fName, String lName, Date pDate, String pNotes, File pScan, String uid) {
		this(fName, lName, pDate, pNotes, wrapScan(pDate, pScan), uid);
		
	}

	// constructor for fresh patient with multiple scans
	public Settings(String fName, String lName, Date pDate, String pNotes, LinkedList<Scan> pScans) {
	...
	public Settings(String fName, String lName, Date pDate, String pNotes, LinkedList<Scan> pScans, String uid) {
