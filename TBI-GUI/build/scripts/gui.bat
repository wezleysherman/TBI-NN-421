...
set CLASSPATH=%APP_HOME%\lib\gui.jar;%APP_HOME%\lib\xom-1.2.10.jar;%APP_HOME%\lib\nekohtml-1.9.22.jar;%APP_HOME%\lib\xalan-2.7.0.jar;%APP_HOME%\lib\xercesImpl-2.11.0.jar

@rem Execute gui
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %GUI_OPTS%  -classpath "%CLASSPATH%" ui.App %CMD_LINE_ARGS%
